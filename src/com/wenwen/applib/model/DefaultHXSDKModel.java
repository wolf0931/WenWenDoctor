 ...
 */
package com.wenwen.applib.model;
...
import com.wenwen.applib.utils.HXPreferenceUtils;
...
public class DefaultHXSDKModel extends HXSDKModel{
    ...
    public boolean saveUid(String uid) {
        // TODO Auto-generated method stub
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.edit().putString(PREF_USERUID, uid).commit();    
    }
    ...
    public String getUid() {
        // TODO Auto-generated method stub
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.getString(PREF_USERUID, null);
    }
    ...
    public String getAccountName() {
        // TODO Auto-generated method stub
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.getString(PREF_ACCOUNTRNAME, null); 
    }

    @Override
    public boolean saveAccountName(String accountname) {
        // TODO Auto-generated method stub
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.edit().putString(PREF_ACCOUNTRNAME, accountname).commit();
    }
}
