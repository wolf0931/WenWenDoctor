 ...
 * 
 */
public class ChatHistoryAdapter extends ArrayAdapter<MyUser> {

	private LayoutInflater inflater;

	public ChatHistoryAdapter(Context context, int textViewResourceId, List<MyUser> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String username = user.getAccount_username();
		// 获取与此用户/群组的会话
